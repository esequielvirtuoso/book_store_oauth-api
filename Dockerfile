...
WORKDIR $GOPATH/src/github.com/esequielvirtuoso/book_store_oauth-api
...
WORKDIR /
COPY --from=build /go/bin/book_store_oauth-api /book_store_oauth-api
EXPOSE 8082
USER nonroot:nonroot
ENTRYPOINT ["/book_store_oauth-api"]
